...
var authSteps = [getAuth, getUpdates, getLibVer, getPromotionsSlim/*, initialConnection*/, callback => setTimeout(login.bind(null, callback), 1000)];
...
{
	// TODO: pass arguments via console
	post("user=USER&password=PASSSWORD&servertype=Classic&checkh=0&version=0", {
